...
export default function UploadPage() {
  const { loadOpsData, loadHrData, opsData, hrData, isLoading, error } = useData();
  ...
  const handleFile = useCallback((file: File, type: 'ops' | 'hr') => {
  ...
  }, [loadOpsData, loadHrData]);

  const handleDrop = useCallback((e: React.DragEvent, type: 'ops' | 'hr') => {
    e.preventDefault();
  ...
  const handleInput = useCallback((e: React.ChangeEvent<HTMLInputElement>, type: 'ops' | 'hr') => {
